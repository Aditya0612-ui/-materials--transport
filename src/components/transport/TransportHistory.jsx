                  ...
                  <Card className="stats-card border-0 shadow-sm h-100">
                    <Card.Body className="d-flex flex-column align-items-center justify-content-center p-3">
                      <div className="icon-wrapper mb-2" style={{
                        ...
                        <i className="bx bx-trip" style={{ fontSize: '24px', color: 'white' }}></i>
                      </div>
                      <h3 className="mb-1 fw-bold" style={{ color: '#065f46' }}>{stats.total}</h3>
                      <p className="mb-0 text-muted small text-center">{t('transport.totalTrips')}</p>
                    </Card.Body>
                  </Card>
                </Col>
                <Col xs={6} xl={2} lg={4} md={6} sm={6}>
                  <Card className="stats-card border-0 shadow-sm h-100">
                    <Card.Body className="d-flex flex-column align-items-center justify-content-center p-3">
                      <div className="icon-wrapper mb-2" style={{
                        ...
                        <i className="bx bx-check-circle" style={{ fontSize: '24px', color: 'white' }}></i>
                      </div>
                      <h3 className="mb-1 fw-bold text-success">{stats.completed}</h3>
                      <p className="mb-0 text-muted small text-center">{t('transport.completed')}</p>
                    </Card.Body>
                  </Card>
                </Col>
                <Col xs={6} xl={2} lg={4} md={6} sm={6}>
                  <Card className="stats-card border-0 shadow-sm h-100">
                    <Card.Body className="d-flex flex-column align-items-center justify-content-center p-3">
                      <div className="icon-wrapper mb-2" style={{
                        ...
                        <i className="bx bx-loader-circle" style={{ fontSize: '24px', color: 'white' }}></i>
                      </div>
                      <h3 className="mb-1 fw-bold text-warning">{stats.inProgress}</h3>
                      <p className="mb-0 text-muted small text-center">{t('transport.inProgress')}</p>
                    </Card.Body>
                  </Card>
                </Col>
                <Col xs={6} xl={2} lg={4} md={6} sm={6}>
                  <Card className="stats-card border-0 shadow-sm h-100">
                    <Card.Body className="d-flex flex-column align-items-center justify-content-center p-3">
                      <div className="icon-wrapper mb-2" style={{
                        ...
                        <i className="bx bx-calendar-event" style={{ fontSize: '24px', color: 'white' }}></i>
                      </div>
                      <h3 className="mb-1 fw-bold text-info">{stats.planned}</h3>
                      <p className="mb-0 text-muted small text-center">{t('transport.planned')}</p>
                    </Card.Body>
                  </Card>
                </Col>
                <Col xs={6} xl={2} lg={4} md={6} sm={6}>
                  <Card className="stats-card border-0 shadow-sm h-100">
                    <Card.Body className="d-flex flex-column align-items-center justify-content-center p-3">
                      <div className="icon-wrapper mb-2" style={{
                        ...
                        <i className="bx bx-map" style={{ fontSize: '24px', color: 'white' }}></i>
                      </div>
                      <h3 className="mb-1 fw-bold" style={{ color: '#6366f1' }}>{stats.totalDistance.toFixed(0)}</h3>
                      <p className="mb-0 text-muted small text-center">{t('transport.totalKM')}</p>
                    </Card.Body>
                  </Card>
                </Col>
                <Col xs={6} xl={2} lg={4} md={6} sm={6}>
                  <Card className="stats-card border-0 shadow-sm h-100">
                    <Card.Body className="d-flex flex-column align-items-center justify-content-center p-3">
                      <div className="icon-wrapper mb-2" style={{
                        ...
                        <i className="bx bx-rupee" style={{ fontSize: '24px', color: 'white' }}></i>
                      </div>
                      <h3 className="mb-1 fw-bold" style={{ color: '#ef4444' }}>₹{stats.totalCost.toFixed(0)}</h3>
                      <p className="mb-0 text-muted small text-center">{t('transport.totalCost')}</p>
                    </Card.Body>
                  </Card>
                </Col>
              </Row>
